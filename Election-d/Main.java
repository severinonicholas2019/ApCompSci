public class Main {
    ...
    public static String [] dvotes = allvotes.split(";");
    public static void main(String[] args) {
        int validvotecount = 0;
        for (int i = 0; i < dvotes.length; i++){
            String voterid = dvotes[i].substring(0,6);
            if (isDuplicate(voterid)) {
                continue;
            }
            validvotecount++;
            String [] votes = dvotes[i].split(",");
        ...
        System.out.println("For the office of Vice President: \n Dona Sarkar received " + v1 + " votes.\nTyler Ahn received " + v2 + " votes.\nJoe Camp received " + v3 + " votes.\nBrandon LeBlanc received " + v4 + " votes.");
        ...
        System.out.println("For the office of Secretary: \nJason Howard received " + s1 + " votes.\nNikki Rubino received " + s2 + " votes.\nPeggy Fisher received " + s3 + " votes.\nNeil Edde received " + s4 + " votes.");
    ...
    public static boolean isDuplicate(String voterid) {
        int numfound = 0;
        for (int i = 0; i < dvotes.length; i++) {
            if (voterid.equals(dvotes[i].substring(0, 6))) {
                numfound++;
            }
        }
